...
<head>
  ...
  <title>Admin Reviews - Trendify</title>
  ...
  <style>
    ...
    img.rev{width:80px;height:60px;object-fit:cover;filter:grayscale(100%)}
  </style>
</head>
<body>
  <div class="layout">
    <aside class="sidebar">
      <div style="font-weight:700;margin-bottom:18px">Trendify Admin</div>
      <nav class="nav">
    ...
    <main>
      ...
      <p style="color:#6b7280">Recent feedback from customers who purchased products.</p>
